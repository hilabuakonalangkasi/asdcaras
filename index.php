		...
		<div class="col-md-8">
			<div class="card">
				<div class="card-body text-center">
					<h4 class="mb-2"><strong>Astronaut Checker</strong></h4>

					<textarea rows="12" class="form-control text-center form-checker mb-2" placeholder="PUT  YOUR CARDS HERE"></textarea>
					<textarea rows="1" class="form-control text-center" id="tgid" placeholder="Telegram ID"></textarea></br>					
					
					          <select name="gate" id="gate" class="form-control" style="margin-bottom: 5px;"
    <option </option>
	           
	            
		    <option style="background:rgba(165, 154, 154, 0.281);color:rgb(255, 208, 0);color:white" value="gate/ccnusd1.php">CCN Charge: $1</option>
                    <option style="background:rgba(165, 154, 154, 0.281);color:rgb(255, 208, 0);color:white" value="gate/cvvusd1.php">CVV Charge: $1</option>
...
<h5>CVV :<span class="badge badge-primary float-right cvvs">0</span></h5><hr>

<h5>CCN :<span class="badge badge-secondary float-right aprovadas">0</span></h5><hr>
...
<footer>
  <p>Modified By <a href="https://t.me/astronautchecker">Astronaut Checker</a></p>
</footer>
<script>
...
if(total > 25000){
  Swal.fire({title: 'YOU CAN NOT PERFORM THAT ACTION: REDUCE NUMBER OF CARDS TO <25000', icon: 'warning', showConfirmButton: false, toast: true, position: 'top-end', timer: 3000});
  return false;
}
